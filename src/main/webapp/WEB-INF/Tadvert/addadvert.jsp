...
<div class="body-box" style="float:right">
	<form id="jvForm" action="../addadv.do" method="post" >
			...
			<tbody id="tab_1">
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						广告标题:</td><td width="80%" class="pn-fcontent">
								<input type="text" name="title" id="title1" onblur="chktitle1()"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<textarea rows="20" cols="20" name="content" id="content" onblur="chkcontent()" ></textarea>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" value="" name="crtime" maxlength="10" class="Wdate" onclick="WdatePicker()"/>
					</td>
				</tr>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text"  name="crman" maxlength="80"  />
					</td>
				</tr>
